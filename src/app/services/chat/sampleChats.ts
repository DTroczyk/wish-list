...
export const SampleChats: Chat[] = [
  ...
  },
  {
    ...
    messages: [
      {
        chatId: 2,
        author: 'user3',
        postDate: new Date(2022, 5, 5, 15, 40, 24),
        text: 'Hello :D',
      },
      {
        chatId: 2,
    ...
    lastAccess: [
      ...
      { user: 'user3', date: new Date(2022, 5, 5, 15, 40, 24), chatId: 2 },
    ],
  },
  {
    id: 3,
    ...
    messages: [
      ...
      },
      {
        chatId: 2,
        author: 'user2',
        postDate: new Date(2022, 5, 5, 15, 45, 24),
        text: 'Hello',
      },
      {
        chatId: 2,
    ...
    lastAccess: [
      { user: 'user2', date: new Date(2022, 5, 5, 15, 45, 24), chatId: 2 },
      { user: 'user3', date: new Date(2022, 5, 5, 15, 40, 24), chatId: 2 },
    ],
  },
];
